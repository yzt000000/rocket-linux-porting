...
//class DefaultConfig extends Config(new WithNBigCores(1)     ++ new WithCoherentBusTopology ++ new BaseConfig)
class DefaultFPGAConfig extends Config(new WithNSmallCores(1) ++ new WithCoherentBusTopology ++ new BaseFPGAConfig)

class DefaultConfigRBB extends Config(
  new WithJtagDTMSystem ++ new WithCoherentBusTopology ++ new WithNBigCores(1) ++ new BaseConfig)

class QuadCoreConfigRBB extends Config(
  new WithJtagDTMSystem ++ new WithCoherentBusTopology ++ new WithNBigCores(4) ++ new BaseConfig)
